...
__Samba, por otro lado, es una implementación libre y de código abierto del protocolo SMB__, que se utiliza principalmente en sistemas operativos basados en Unix y Linux. __Samba proporciona una manera de compartir archivos y recursos entre dispositivos de red que ejecutan sistemas operativos diferentes, como Windows y Linux__.
...
CUANDO SE ESTA CON UNA MAQUINA CON EL PUERTO 445 ABIERTO -> smbclient -L IP
    - Para listar los recursos compartidos a nivel de red
    -N Sesion nula

Para saber nivel de lectura y escritura: smbmap -H IP : Te muestra info de PERMISOS 

EJEMPLO
- smbclient //127.0.0.1/myshare -N : Te conectas y segun los permisos puedes subir Archivos.